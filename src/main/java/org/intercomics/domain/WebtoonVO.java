...
public class WebtoonVO {
	...
	public String toString() {
		return "WebtoonVO [webtoonId=" + webtoonId + ", webtoonName=" + webtoonName + ", webtoonThumbnail_s="
				...
				+ webtoonThumbnail_b + ", webtoonIntroduce=" + webtoonIntroduce + ", lastDate=" + lastDate + ", day="
				+ day + ", genre=" + genre + ", platform=" + platform + ", writer=" + writer + ", isUpdate=" + isUpdate
				+ ", isNew=" + isNew + ", viewCount=" + viewCount + "]";
	}
